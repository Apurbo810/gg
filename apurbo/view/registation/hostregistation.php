...
if(isset($_SESSION['form_data'])){
    $username = isset($_SESSION['form_data']['username']) ? str_replace("Ho-","",$_SESSION['form_data']['username']) : '';
...
<body>
    ...
    unset($_SESSION['phoneErr']);
        ...
        Username:  <input type="text" name="username" id="Username" value="Ho-<?php if(isset($username)){echo $username;} ?>" oninput="ajax()">
        <p id="availability"></p>
